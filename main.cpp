...
int main()
{
    ...
    std::cout << "You will have to enter all necessary data manually through command line interface." << std::endl;
    ...
    std::cout << "3.5. Converter is case-sensitive. That means, for example, \"0123456789abcdef\" is not the same as \"0123456789ABCDEF\"" << std::endl;
    ...
    std::cout << "Your number " << userNumber << " is converted from \n\" " << userNumeralSourceSystem << " \"" << std::endl;
    std::cout << "into \" " << userNumeralDestinationSystem << " \". The result is: ";
